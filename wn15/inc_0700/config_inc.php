...
define('LOG_ALL_ERRORS', FALSE); # TRUE = TRACK ALL ERRORS IN ERROR LOG FILE (UPDATED 7/14 FOR ZEPHIR!)
...
define('VIRTUAL_PATH', 'http://curtissmelvin.com/itc250/wn15/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/var/www/itc250/wn15/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'curtissm@hotmail.com'); # Email of site support
define('PREFIX', 'wn15_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
$config->style = 'default.css'; #currently only Bootswatch Theme uses style to switch look & feel
...
$config->banner = 'No Colets please..'; #goes inside header - can be overwritten
...
$nav1['Surveys/survey_list.php'] = "Surveys~The entrance to our Survey App";
