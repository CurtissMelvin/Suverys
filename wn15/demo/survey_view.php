...
/**
 * 
 * survey_view.php along with demo_view_pager.php provides a sample web application
 *
 ...
 * @see survey_view.php
 * @see Pager_inc.php 
 * @todo Creaate survey_view.php page
 */
...
$sql = "select SurveyID, Title, Description from wn15_surveys where SurveyID = " . $myID;
//---end config area --------------------------------------------------
...
?>
	...
	<div align="center"><a href="<?=VIRTUAL_PATH;?>surveys/index.php">Back to Survey List</a></div>
