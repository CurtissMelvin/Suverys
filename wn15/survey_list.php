 ...
 * 
 * survey_list.php along with demo_view_pager.php provides a sample web application
 *
...
{#records exist - process
	...
	{# process each row
         echo '<div align="center">
					<a href="' . VIRTUAL_PATH . 'surveys/survey_view.php?
						id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a>';
